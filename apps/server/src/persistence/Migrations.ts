...
import Migration0020 from "./Migrations/020_PreviewUrls.ts";
import Migration0021 from "./Migrations/021_PreviewUrlTurnId.ts";
...
export const migrationEntries = [
  ...
  [20, "PreviewUrls", Migration0020],
  [21, "PreviewUrlTurnId", Migration0021],
] as const;
